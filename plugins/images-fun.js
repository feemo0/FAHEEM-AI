...
await conn.sendMessage(from,{image :{ url: `https://cdn-bandaheali.vercel.app/file/ADEEL-MD41321.jpg` },caption: '> 𝙁𝘼𝙃𝙀𝙀𝙈-𝘼𝙄' },{quoted:mek});
...
await conn.sendMessage(from,{image :{ url: `https://cdn-bandaheali.vercel.app/file/ADEEL-MD41321.jpg` },caption: '> 𝙁𝘼𝙃𝙀𝙀𝙈-𝘼𝙐' },{quoted:mek});
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { image: { url: data.message }, caption: '> *𝙁𝘼𝙃𝙀𝙀𝙈-𝘼𝙄 FAHEEM-AI> ' }, { quoted: mek });
    } catch (e) {
