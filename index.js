...
if (!fs.existsSync(sessionFile)) {
    ...
    if (sessionId && sessionId.trim() !== "" && sessionId.startsWith("FAHEEM-AI~")) {
        ...
        console.log("SESSION_ID missing or invalid! Add to Heroku Config")
        console.log("Format: FAHEEM-AI~base64string")
        process.exit(1)
    }
}
