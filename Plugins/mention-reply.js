  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(
        config.MENU_IMAGE_URL || "https://files.catbox.moe/a6d73s.jpg",
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "FAHEEM-AI 🥀",
            body: config.DESCRIPTION || "𝙁𝘼𝙃𝙀𝙀𝙈-𝘼𝙄 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/a6d73s.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/61480853796",
